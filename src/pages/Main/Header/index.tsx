...
export const Header: React.FC = () => {
  return (
    <header className="w-full flex flex-col-reverse md:flex-row h-auto md:h-screen text-white bg-[#392B30] items-center justify-center md:gap-32 md:py-16 md:px-8">
      <div className="w-full flex flex-col max-w-[660px] px-10 md:px-0 py-14 md:py-0">
        <div className="w-full mb-4 md:mb-[88px]">
          ...
          <h1 className="text-[72px] leading-[72px] md:text-[156px] md:leading-[156px] font-FreightBigProLight text-[#F2CBCB]">
            revoluciona
          </h1>
        </div>
